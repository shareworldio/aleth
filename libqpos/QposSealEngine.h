...
public:
	...
	virtual void initEnv(class Client *_c, p2p::Host *_host, std::shared_ptr<EthereumCapability> _capability, BlockChain* _bc, bool _importAnyNode);
	...
	virtual void generateSeal(bytes const&) {};
	void generateSeal(BlockHeader const& _bi) override { (void)_bi; };
...
protected:
	...
	void send(NodeID const& _id, RLPStream& _msg);
